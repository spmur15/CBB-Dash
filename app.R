...
# #Players$PCS[Players$PCS>99]=99
# Players$PCS[Players$Player != "Zach Edey" & 
#               Players$Player != "Tyler Kolek" &
#               Players$Player != "A.J. Storr" & 
#               Players$PCS>91]=Players$PCS[Players$Player != "Zach Edey" & 
#                                             Players$Player != "Tyler Kolek" & 
#                                             Players$Player != "A.J. Storr" & 
#                                             Players$PCS>91]-1.5
# Players$PCS[Players$Player == "A.J. Storr"] = Players$PCS[Players$Player == "A.J. Storr"]+5
# Players$PCS[Players$Player == "Chucky Hepburn"] = Players$PCS[Players$Player == "Chucky Hepburn"]-2
# Players$PCS[Players$Player == "Dajuan Harris, Jr."] = Players$PCS[Players$Player == "Dajuan Harris, Jr."]+2.5
# Players$PCS[Players$Player == "Dalton Knecht"] = Players$PCS[Players$Player == "Dalton Knecht"]+8
# Players$PCS[Players$Player == "Jonathan Mogbo"] = Players$PCS[Players$Player == "Jonathan Mogbo"]-2
# Players$PCS[Players$Player == "Kyle Filipowski"] = Players$PCS[Players$Player == "Kyle Filipowski"]+2
# Players$PCS[Players$Player == "Braden Smith"] = Players$PCS[Players$Player == "Braden Smith"]-2
# Players$PCS[Players$Player == "R.J. Davis"] = Players$PCS[Players$Player == "R.J. Davis"]+2
# Players$PCS[Players$Player == "Jahmir Young"] = Players$PCS[Players$Player == "Jahmir Young"]-1.25
# Players$PCS[Players$Player == "Hunter Dickinson"] = Players$PCS[Players$Player == "Hunter Dickinson"]-1.8
# Players$PCS[Players$Player == "Terrence Shannon, Jr."] = Players$PCS[Players$Player == "Terrence Shannon, Jr."]+4
# Players$PCS[Players$Player == "Mark Sears"] = Players$PCS[Players$Player == "Mark Sears"]+2.5
# Players$PCS[Players$Player == "Zach Edey"] = Players$PCS[Players$Player == "Zach Edey"]-4
# Players$PCS[Players$Player == "Jamal Shead"] = Players$PCS[Players$Player == "Jamal Shead"]+1.25
# Players$PCS[Players$Player == "Jalen Washington"] = Players$PCS[Players$Player == "Jalen Washington"]-1.5
# Players$PCS[Players$Player == "Rob Dillingham"] = Players$PCS[Players$Player == "Rob Dillingham"]+1.5
# Players$PCS[Players$Player == "Isaiah Collier"] = Players$PCS[Players$Player == "Isaiah Collier"]-1.5
# Players$PCS[Players$Player == "Markus Burton"] = Players$PCS[Players$Player == "Markus Burton"]-1.5
# Players$PCS[Players$Player == "Cameron Tyson"] = Players$PCS[Players$Player == "Cameron Tyson"]+1.5
# Players$PCS[Players$Player == "Johnell Davis"] = Players$PCS[Players$Player == "Johnell Davis"]+2
# Players$PCS[Players$Player == "Cliff Omoruyi"] = Players$PCS[Players$Player == "Cliff Omoruyi"]+2
# Players$PCS[Players$Player == "Jeremy Roach"] = Players$PCS[Players$Player == "Jeremy Roach"]+0.5
# Players$PCS[Players$Player == "Coleman Hawkins"] = Players$PCS[Players$Player == "Coleman Hawkins"]+0.5
# 
# Players$PCS[Players$Player == "Donovan Clingan"] = Players$PCS[Players$Player == "Donovan Clingan"]-1.5
# #Players$PCS[Players$Player == "Ryan Kalkbrenner"] = Players$PCS[Players$Player == "Ryan Kalkbrenner"]-3
# 
# Players$PCS[Players$Player == 'A.J. Storr'] = Players$PCS[Players$Player == "A.J. Storr"] + 1.5
# Players$PCS[Players$Player == 'Walter Clayton'] = Players$PCS[Players$Player == "Walter Clayton"] + 3
# Players$PCS[Players$Player == 'A.J. Hoggard'] = Players$PCS[Players$Player == "A.J. Hoggard"] - 2.5
# Players$PCS[Players$Player == 'Kam Jones'] = Players$PCS[Players$Player == "Kam Jones"] + 1
# Players$PCS[Players$Player == 'Myles Rice'] = Players$PCS[Players$Player == "Myles Rice"] + 2.5
# Players$PCS[Players$Player == 'Emanuel Sharp'] = Players$PCS[Players$Player == "Emanuel Sharp"] - 2
# Players$PCS[Players$Player == 'Wade Taylor IV'] = Players$PCS[Players$Player == "Wade Taylor IV"] + 0.3
# Players$PCS[Players$Player == 'Julian Reese'] = Players$PCS[Players$Player == "Julian Reese"] - 0.7
# Players$PCS[Players$Player == 'Brooks Barnhizer'] = Players$PCS[Players$Player == "Brooks Barnhizer"] - 0.6
# Players$PCS[Players$Player == 'Ace Baldwin'] = Players$PCS[Players$Player == "Ace Baldwin"] - 1.5
# Players$PCS[Players$Player == 'Rollie Worster'] = Players$PCS[Players$Player == "Rollie Worster"]
# Players$PCS[Players$Player == 'Ryan Nembhard'] = Players$PCS[Players$Player == "Ryan Nembhard"] + 1.5
# Players$PCS[Players$Player == 'Josh Hubbard'] = Players$PCS[Players$Player == "Josh Hubbard"] + 0.8
# Players$PCS[Players$Player == 'Hunter Sallis'] = Players$PCS[Players$Player == "Hunter Sallis"] + 1.5
# Players$PCS[Players$Player == 'Keshon Gilbert'] = Players$PCS[Players$Player == "Keshon Gilbert"] - 1
# Players$PCS[Players$Player == 'Chaz Lanier'] = Players$PCS[Players$Player == "Chaz Lanier"] + 1.9
# Players$PCS[Players$Player == 'Tyrese Proctor'] = Players$PCS[Players$Player == "Tyrese Proctor"] + 1
# Players$PCS[Players$Player == 'Johnell Davis'] = Players$PCS[Players$Player == "Johnell Davis"] + 2.2
# Players$PCS[Players$Player == 'Dajuan Harris, Jr.'] = Players$PCS[Players$Player == "Dajuan Harris, Jr."] + 2
# Players$PCS[Players$Player == 'Milos Uzan'] = Players$PCS[Players$Player == "Milos Uzan"] + 2
# Players$PCS[Players$Player == 'Mylik Wilson'] = Players$PCS[Players$Player == "Mylik Wilson"] - 2
# 
# 
# 
# 
# 
# #Players$PCS[Players$Player == "Cam Spencer"] = Players$PCS[Players$Player == "Cam Spencer"]-1
# #Players$PCS[Players$Player == "Tristen Newton"] = Players$PCS[Players$Player == "Tristen Newton"]+1
# #Players = Players %>% arrange(desc(PCS))
# 
# 
# #pcsDF$PCS[pcsDF$PCS>99]=99
# pcsDF$PCS[pcsDF$Player != "Zach Edey" & 
#             pcsDF$Player != "Tyler Kolek" &
#             pcsDF$Player != "A.J. Storr" & 
#             pcsDF$PCS>91]=pcsDF$PCS[pcsDF$Player != "Zach Edey" & 
#                                     pcsDF$Player != "Tyler Kolek" & 
#                                     pcsDF$Player != "A.J. Storr" & 
#                                     pcsDF$PCS>91]-1.5
# 
# pcsDF$PCS[pcsDF$Player == "A.J. Storr"] = pcsDF$PCS[pcsDF$Player == "A.J. Storr"]+5
# pcsDF$PCS[pcsDF$Player == "Chucky Hepburn"] = pcsDF$PCS[pcsDF$Player == "Chucky Hepburn"]-2
# pcsDF$PCS[pcsDF$Player == "Dajuan Harris, Jr."] = pcsDF$PCS[pcsDF$Player == "Dajuan Harris, Jr."]+2.5
# pcsDF$PCS[pcsDF$Player == "Dalton Knecht"] = pcsDF$PCS[pcsDF$Player == "Dalton Knecht"]+8
# pcsDF$PCS[pcsDF$Player == "Jonathan Mogbo"] = pcsDF$PCS[pcsDF$Player == "Jonathan Mogbo"]-2
# pcsDF$PCS[pcsDF$Player == "Kyle Filipowski"] = pcsDF$PCS[pcsDF$Player == "Kyle Filipowski"]+2
# pcsDF$PCS[pcsDF$Player == "Braden Smith"] = pcsDF$PCS[pcsDF$Player == "Braden Smith"]-2
# pcsDF$PCS[pcsDF$Player == "R.J. Davis"] = pcsDF$PCS[pcsDF$Player == "R.J. Davis"]+2
# pcsDF$PCS[pcsDF$Player == "Jahmir Young"] = pcsDF$PCS[pcsDF$Player == "Jahmir Young"]-1.25
# pcsDF$PCS[pcsDF$Player == "Hunter Dickinson"] = pcsDF$PCS[pcsDF$Player == "Hunter Dickinson"]-1.8
# pcsDF$PCS[pcsDF$Player == "Terrence Shannon, Jr."] = pcsDF$PCS[pcsDF$Player == "Terrence Shannon, Jr."]+4
# pcsDF$PCS[pcsDF$Player == "Mark Sears"] = pcsDF$PCS[pcsDF$Player == "Mark Sears"]+2.5
# pcsDF$PCS[pcsDF$Player == "Zach Edey"] = pcsDF$PCS[pcsDF$Player == "Zach Edey"]-4
# pcsDF$PCS[pcsDF$Player == "Jamal Shead"] = pcsDF$PCS[pcsDF$Player == "Jamal Shead"]+1.25
# pcsDF$PCS[pcsDF$Player == "Jalen Washington"] = pcsDF$PCS[pcsDF$Player == "Jalen Washington"]-1.5
# pcsDF$PCS[pcsDF$Player == "Rob Dillingham"] = pcsDF$PCS[pcsDF$Player == "Rob Dillingham"]+1.5
# pcsDF$PCS[pcsDF$Player == "Isaiah Collier"] = pcsDF$PCS[pcsDF$Player == "Isaiah Collier"]-1.5
# pcsDF$PCS[pcsDF$Player == "Markus Burton"] = pcsDF$PCS[pcsDF$Player == "Markus Burton"]-1.5
# pcsDF$PCS[pcsDF$Player == "Cameron Tyson"] = pcsDF$PCS[pcsDF$Player == "Cameron Tyson"]+1.5
# pcsDF$PCS[pcsDF$Player == "Johnell Davis"] = pcsDF$PCS[pcsDF$Player == "Johnell Davis"]+2
# pcsDF$PCS[pcsDF$Player == "Cliff Omoruyi"] = pcsDF$PCS[pcsDF$Player == "Cliff Omoruyi"]+2
# pcsDF$PCS[pcsDF$Player == "Jeremy Roach"] = pcsDF$PCS[pcsDF$Player == "Jeremy Roach"]+0.5
# pcsDF$PCS[pcsDF$Player == "Coleman Hawkins"] = pcsDF$PCS[pcsDF$Player == "Coleman Hawkins"]+0.5
# 
# pcsDF$PCS[pcsDF$Player == "Donovan Clingan"] = pcsDF$PCS[pcsDF$Player == "Donovan Clingan"]-1.5
# #pcsDF$PCS[pcsDF$Player == "Ryan Kalkbrenner"] = pcsDF$PCS[pcsDF$Player == "Ryan Kalkbrenner"]-3
# 
# pcsDF$PCS[pcsDF$Player == "A.J. Storr"] = pcsDF$PCS[pcsDF$Player == "A.J. Storr"]+1.5
# pcsDF$PCS[pcsDF$Player == 'Walter Clayton'] = pcsDF$PCS[pcsDF$Player == "Walter Clayton"] + 3
# pcsDF$PCS[pcsDF$Player == 'A.J. Hoggard'] = pcsDF$PCS[pcsDF$Player == "A.J. Hoggard"] - 2.5
# pcsDF$PCS[pcsDF$Player == 'Kam Jones'] = pcsDF$PCS[pcsDF$Player == "Kam Jones"] + 1
# pcsDF$PCS[pcsDF$Player == 'Myles Rice'] = pcsDF$PCS[pcsDF$Player == "Myles Rice"] + 2.5
# pcsDF$PCS[pcsDF$Player == 'Emanuel Sharp'] = pcsDF$PCS[pcsDF$Player == "Emanuel Sharp"] - 2
# pcsDF$PCS[pcsDF$Player == 'Wade Taylor IV'] = pcsDF$PCS[pcsDF$Player == "Wade Taylor IV"] + 0.3
# pcsDF$PCS[pcsDF$Player == 'Julian Reese'] = pcsDF$PCS[pcsDF$Player == "Julian Reese"] - 0.7
# pcsDF$PCS[pcsDF$Player == 'Brooks Barnhizer'] = pcsDF$PCS[pcsDF$Player == "Brooks Barnhizer"] - 0.6
# pcsDF$PCS[pcsDF$Player == 'Ace Baldwin'] = pcsDF$PCS[pcsDF$Player == "Ace Baldwin"] - 1.5
# pcsDF$PCS[pcsDF$Player == 'Rollie Worster'] = pcsDF$PCS[pcsDF$Player == "Rollie Worster"]
# pcsDF$PCS[pcsDF$Player == 'Ryan Nembhard'] = pcsDF$PCS[pcsDF$Player == "Ryan Nembhard"] + 1.5
# pcsDF$PCS[pcsDF$Player == 'Josh Hubbard'] = pcsDF$PCS[pcsDF$Player == "Josh Hubbard"] + 0.8
# pcsDF$PCS[pcsDF$Player == 'Hunter Sallis'] = pcsDF$PCS[pcsDF$Player == "Hunter Sallis"] + 1.5
# pcsDF$PCS[pcsDF$Player == 'Keshon Gilbert'] = pcsDF$PCS[pcsDF$Player == "Keshon Gilbert"] - 1
# pcsDF$PCS[pcsDF$Player == 'Chaz Lanier'] = pcsDF$PCS[pcsDF$Player == "Chaz Lanier"] + 1.9
# pcsDF$PCS[pcsDF$Player == 'Tyrese Proctor'] = pcsDF$PCS[pcsDF$Player == "Tyrese Proctor"] + 1
# pcsDF$PCS[pcsDF$Player == 'Johnell Davis'] = pcsDF$PCS[pcsDF$Player == "Johnell Davis"] + 2.2
# pcsDF$PCS[pcsDF$Player == 'Dajuan Harris'] = pcsDF$PCS[pcsDF$Player == "Dajuan Harris"] + 2
# pcsDF$PCS[pcsDF$Player == 'Milos Uzan'] = pcsDF$PCS[pcsDF$Player == "Milos Uzan"] + 2
# pcsDF$PCS[pcsDF$Player == 'Mylik Wilson'] = pcsDF$PCS[pcsDF$Player == "Mylik Wilson"] - 2

pcsDF$PCS[pcsDF$Player == 'Julian Reese'] = pcsDF$PCS[pcsDF$Player == "Julian Reese"] - 2
Players$PCS[Players$Player == "Julian Reese"] = Players$PCS[Players$Player == "Julian Reese"] - 2

pcsDF$PCS[pcsDF$Player == 'Zakai Zeigler'] = pcsDF$PCS[pcsDF$Player == "Zakai Zeigler"] - 2
Players$PCS[Players$Player == "Zakai Zeigler"] = Players$PCS[Players$Player == "Zakai Zeigler"] - 2

pcsDF$PCS[pcsDF$Player == 'Walter Clayton, Jr.'] = pcsDF$PCS[pcsDF$Player == "Walter Clayton, Jr."] + 1.4
Players$PCS[Players$Player == "Walter Clayton, Jr."] = Players$PCS[Players$Player == "Walter Clayton, Jr."] + 1.4

#pcsDF$PCS[pcsDF$Player == "Cam Spencer"] = pcsDF$PCS[pcsDF$Player == "Cam Spencer"]-1
historicPCS$PCS[historicPCS$Player == "Denzel Valentine" &
                  historicPCS$Year == '2015-16'] = historicPCS$PCS[historicPCS$Player == "Denzel Valentine" &
                                                                     historicPCS$Year == '2015-16']+1
historicPCS$PCS[historicPCS$Player == "Keegan Murray" &
                  historicPCS$Year == '2021-22'] = historicPCS$PCS[historicPCS$Player == "Keegan Murray" &
                                                                     historicPCS$Year == '2021-22']-1.5
historicPCS$PCS[historicPCS$Player == "Kevin Durant" &
                  historicPCS$Year == '2006-07'] = historicPCS$PCS[historicPCS$Player == "Kevin Durant" &
                                                                     historicPCS$Year == '2006-07']+1.5
historicPCS$PCS[historicPCS$Player == "R.J. Barrett" &
                  historicPCS$Year == '2018-19'] = historicPCS$PCS[historicPCS$Player == "R.J. Barrett" &
                                                                     historicPCS$Year == '2018-19']-2.5
historicPCS$PCS[historicPCS$Player == "Frank Mason" &
                  historicPCS$Year == '2016-17'] = historicPCS$PCS[historicPCS$Player == "Frank Mason" &
                                                                     historicPCS$Year == '2016-17']+2
historicPCS$PCS[historicPCS$Player == "Cassius Winston" &
                  historicPCS$Year == '2018-19'] = historicPCS$PCS[historicPCS$Player == "Cassius Winston" &
                                                                     historicPCS$Year == '2018-19']+2
historicPCS$PCS[historicPCS$Player == "Cassius Winston" &
                  historicPCS$Year == '2019-20'] = historicPCS$PCS[historicPCS$Player == "Cassius Winston" &
                                                                     historicPCS$Year == '2019-20']+1

historicPCS$PCS[historicPCS$Player == "Xavier Tillman Sr." &
                  historicPCS$Year == '2019-20'] = historicPCS$PCS[historicPCS$Player == "Xavier Tillman Sr." &
                                                                     historicPCS$Year == '2019-20']-1.5

historicPCS$PCS[historicPCS$Player == "Trae Young" &
                  historicPCS$Year == '2017-18'] = historicPCS$PCS[historicPCS$Player == "Trae Young" &
                                                                     historicPCS$Year == '2017-18']-2.5

historicPCS$PCS[historicPCS$Player == "Buddy Hield" &
                  historicPCS$Year == '2015-16'] = historicPCS$PCS[historicPCS$Player == "Buddy Hield" &
                                                                     historicPCS$Year == '2015-16']+2.5

historicPCS$PCS[historicPCS$Player == "Johnny Davis" &
                  historicPCS$Year == '2021-22'] = historicPCS$PCS[historicPCS$Player == "Johnny Davis" &
                                                                     historicPCS$Year == '2021-22']+2.5
#historicPCS$PCS[historicPCS$PCS>99]=99
#pcsDF$PCS[pcsDF$PCS<86]=pcsDF$PCS[pcsDF$PCS<86]+1
#Players$PCS[Players$PCS<86]=Players$PCS[Players$PCS<86]+1

#historicPCS$PCS[historicPCS$PCS>95 & historicPCS$PCS<96.5] = historicPCS$PCS[historicPCS$PCS>95 & historicPCS$PCS<96.5]+0.75
#historicPCS$PCS[historicPCS$PCS<95] = historicPCS$PCS[historicPCS$PCS<95]+1.5
